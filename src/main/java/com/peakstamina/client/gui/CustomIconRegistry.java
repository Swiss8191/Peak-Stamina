...
public class CustomIconRegistry {
    ...
    private static ResourceLocation getOrUploadTexture(String name) {
        ...
        ResourceLocation loc = new ResourceLocation(peakStaminaMod.MODID, "custom_icon/" + name.toLowerCase(java.util.Locale.ROOT));
    ...
    public static void drawIcon(GuiGraphics gfx, int x, int y, int w, int h,
        ...
        buf.vertex(matrix, x,     y,     0).uv(0, 0).color(r, g, b, a).endVertex();
        buf.vertex(matrix, x,     y + h, 0).uv(0, 1).color(r, g, b, a).endVertex();
        buf.vertex(matrix, x + w, y + h, 0).uv(1, 1).color(r, g, b, a).endVertex();
        buf.vertex(matrix, x + w, y,     0).uv(1, 0).color(r, g, b, a).endVertex();
