...
public class StaminaConfig {
    ...
    public static class Common {
        ...
        public ModConfigSpec.BooleanValue enableAttackCooldownWhenExhausted;
        public ModConfigSpec.IntValue exhaustedAttackCooldownDuration;
        ...
        private void initCombat(ModConfigSpec.Builder builder) {
            ...
            itemInterruptionCooldown = builder.comment(" Ticks to disable an item if you run out of stamina while using it. (Shields and stuff, NOT WEAPONS").defineInRange("itemInterruptionCooldown", 120, 0, 1200);
            ...
            exhaustedAttackCooldownDuration = builder.comment(" Duration (in ticks) of the weapon cooldown when attacking while out of stamina (20 ticks = 1s).").defineInRange("exhaustedAttackCooldownDuration", 80, 0, 12000);
            builder.pop();
        }
