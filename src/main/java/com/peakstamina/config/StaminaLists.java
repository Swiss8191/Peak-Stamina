...
public class StaminaLists {
    ...
    public static final ModConfigSpec LISTS_SPEC;

    static {
        final Pair<Lists, ModConfigSpec> specPair = new ModConfigSpec.Builder().configure(Lists::new);
    ...
    public static class Lists {
        ...
        private static final List<String> DEFAULT_ITEM_COST_TAGS = Arrays.asList(
                ...
                "c:tools/shield;TICK;0.2;BLOCK;2.0;0.8"
        );
        ...
        public ModConfigSpec.ConfigValue<List<? extends String>> itemCosts;
        public ModConfigSpec.ConfigValue<List<? extends String>> itemCostTags;
        public ModConfigSpec.ConfigValue<List<? extends String>> customExhaustionPenalties;
        public ModConfigSpec.ConfigValue<List<? extends String>> infiniteStaminaEffects;
        public ModConfigSpec.ConfigValue<List<? extends String>> universalPenalties;
        public ModConfigSpec.ConfigValue<List<? extends String>> universalBuffs;
        public ModConfigSpec.ConfigValue<List<? extends String>> consumableValues;
        public ModConfigSpec.ConfigValue<List<? extends String>> customContainerPaths;
        ...
        private void initOtherLists(ModConfigSpec.Builder builder) {
        ...
        private void initItemCosts(ModConfigSpec.Builder builder) {
        ...
        private void initUniversalPenalties(ModConfigSpec.Builder builder) {
        ...
        private void initUniversalBuffs(ModConfigSpec.Builder builder) {
